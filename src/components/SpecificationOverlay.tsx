              ...
              {currentSectionIndex !== 0 && (
                ...
                >
                  <div
                    ...
                    className="flex gap-6 md:gap-8 bg-black/15 backdrop-blur-xl border border-white/10 p-3 px-6 rounded-full shadow-[0_12px_40px_rgba(0,0,0,0.5)] cursor-pointer hover:bg-black/25 transition-all text-left"
                  >
                  {/* Active model label */}
                  <div className="flex items-center gap-2 pr-4 border-r border-[#ffffff]/8 shrink-0">
                    <UploadCloud className="w-3.5 h-3.5 text-creme" />
                    <span className="text-[8px] font-mono uppercase tracking-[0.15em] text-stone-300 font-bold">
                      {isCustomLoaded ? `Yacht: ${uploadedFileName.substring(0, 14)}` : "UPLOAD DESIGN (.GLB)"}
                    </span>
                  </div>
